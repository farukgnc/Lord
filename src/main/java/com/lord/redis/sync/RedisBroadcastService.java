...
public class RedisBroadcastService extends JedisPubSub {
    ...
    @Getter
    private static final String CHANNEL = "lord:broadcast";

    public RedisBroadcastService(ServiceRegistry serviceRegistry) {
